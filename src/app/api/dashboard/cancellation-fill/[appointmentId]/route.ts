...
export async function GET(req: NextRequest, { params }: { params: { appointmentId: string } }) {
  try {
    ...
    return handleApiError(error, 'GET /api/dashboard/cancellation-fill/[appointmentId]')
  }
}
...
export async function POST(req: NextRequest, { params }: { params: { appointmentId: string } }) {
  try {
    ...
    return handleApiError(error, 'POST /api/dashboard/cancellation-fill/[appointmentId]')
  }
}
